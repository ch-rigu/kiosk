...
const vue_app = Vue.createApp({
  data() {
    return {
      ...
      items: [{'name': 'kitsune', 'price': 1000, 'tags': ['',''], 'id':'xxx-xxx-kitsune','description':'original from japan'},
              {'name': 'Fujiyama', 'price': 1000, 'tags': ['',''], 'id':'xxx-xxx-kitsune','description':'original from japan'},
              {'name': 'Neko', 'price': 1000, 'tags': ['',''], 'id':'xxx-xxx-kitsune','description':'original from japan'},
              {'name': 'Neko', 'price': 1000, 'tags': ['',''], 'id':'xxx-xxx-kitsune','description':'original from japan'},
  ...
  methods: {
    getItems(){
      ...
      .then(response => {
        ...
        document.getElementById('editor').innerHTML = response.data;
